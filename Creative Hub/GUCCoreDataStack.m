...
@implementation GUCCoreDataStack
...
+ (instancetype)defaultStack {
  static GUCCoreDataStack *defaultStack;
...
- (NSManagedObjectModel *)managedObjectModel {
  ...
  NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"Creative_Hub"
                                            withExtension:@"momd"];
  _managedObjectModel =
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
  ...
  NSURL *storeURL = [[self applicationDocumentsDirectory]
      URLByAppendingPathComponent:@"Creative_Hub.sqlite"];
